...
import 'package:macc/ui/auth/signup/sign_up_bloc.dart';
import 'package:macc/ui/home/home_screen.dart';
import 'package:macc/ui/loading_cubit.dart';
                          ...
                          Padding(
                            ...
                            child: ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                primary: const Color(constants.COLOR_PRIMARY),
                                padding:
                            ...
                            trailing: BlocBuilder<SignUpBloc, SignUpState>(
                              ...
                              builder: (context, state) {
                                ...
                                return Checkbox(
                                  ...
                                  activeColor: const Color(constants.COLOR_PRIMARY),
                                  value: acceptEULA,
                                );
                              },
                            ),
                                ...
                                children: [
                                  ...
                                  TextSpan(
                                    ...
                                    recognizer: TapGestureRecognizer()
                                      ..onTap = () async {
                                        if (await canLaunch(constants.EULA)) {
                                          await launch(
                                            constants.EULA,
                                            forceSafariVC: false,
                                          );
